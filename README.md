# Mumma's Kitchen Backend

Mumma's Kitchen Backend is the REST API for a meal-ordering platform where customers can browse messes, view meals, place orders, and track order status, while owners can manage their mess and monitor business activity.
